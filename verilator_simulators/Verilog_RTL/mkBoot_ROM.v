...
//
// On Mon Feb  3 22:06:16 GMT 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkBoot_ROM(CLK,
  ...
  wire [72 : 0] slave_xactor_shim_wff$D_IN;
  ...
  reg [63 : 0] data64__h2414;
  reg [31 : 0] CASE_byte_addr112_16_0x0_24_0x0_32_0x54040000__ETC__q1,
	       CASE_byte_addr112_16_0x28067_24_0x80000000_32__ETC__q2;
  wire [63 : 0] byte_addr__h2112, rdata__h2354;
  wire NOT_slave_xactor_shim_arff_first__0_BITS_31_TO_ETC___d62,
       NOT_slave_xactor_shim_awff_first__272_BITS_31__ETC___d1282;
  ...
  assign slave_xactor_shim_rff$D_IN =
	     { slave_xactor_shim_arff$D_OUT[99:93],
	       rdata__h2354,
	       NOT_slave_xactor_shim_arff_first__0_BITS_31_TO_ETC___d62 ?
		 2'd2 :
		 2'd0,
	       1'd1 } ;
  ...
  // remaining internal signals
  assign NOT_slave_xactor_shim_arff_first__0_BITS_31_TO_ETC___d62 =
	     slave_xactor_shim_arff$D_OUT[31:29] != 3'b0 ||
	     rg_addr_base > slave_xactor_shim_arff$D_OUT[92:29] ||
	     slave_xactor_shim_arff$D_OUT[92:29] >= rg_addr_lim ;
  assign NOT_slave_xactor_shim_awff_first__272_BITS_31__ETC___d1282 =
	     slave_xactor_shim_awff$D_OUT[31:29] != 3'b0 ||
	     rg_addr_base > slave_xactor_shim_awff$D_OUT[92:29] ||
	     slave_xactor_shim_awff$D_OUT[92:29] >= rg_addr_lim ;
  assign byte_addr__h2112 =
	     slave_xactor_shim_arff$D_OUT[92:29] - rg_addr_base ;
  assign rdata__h2354 =
	     NOT_slave_xactor_shim_arff_first__0_BITS_31_TO_ETC___d62 ?
	       64'd0 :
	       data64__h2414 ;
  always@(byte_addr__h2112)
  begin
    case (byte_addr__h2112)
      64'd16,
      64'd24,
      64'd56,
      64'd72,
      ...
      64'd4080,
      64'd4088:
	  CASE_byte_addr112_16_0x0_24_0x0_32_0x54040000__ETC__q1 = 32'h0;
      64'd32:
	  CASE_byte_addr112_16_0x0_24_0x0_32_0x54040000__ETC__q1 =
	      32'h54040000;
      64'd40:
	  CASE_byte_addr112_16_0x0_24_0x0_32_0x54040000__ETC__q1 =
	      32'h88030000;
	  ...
	  CASE_byte_addr112_16_0x0_24_0x0_32_0x54040000__ETC__q1 =
	      32'h68732D67;
      default: CASE_byte_addr112_16_0x0_24_0x0_32_0x54040000__ETC__q1 =
		   32'hAAAAAAAA;
    endcase
  end
  always@(byte_addr__h2112)
  begin
    case (byte_addr__h2112)
      ...
      64'd4080,
      64'd4088:
	  CASE_byte_addr112_16_0x28067_24_0x80000000_32__ETC__q2 = 32'h0;
	  ...
	  CASE_byte_addr112_16_0x28067_24_0x80000000_32__ETC__q2 =
	      32'h00746669;
      default: CASE_byte_addr112_16_0x28067_24_0x80000000_32__ETC__q2 =
		   32'hAAAAAAAA;
    endcase
  end
  always@(byte_addr__h2112 or
	  CASE_byte_addr112_16_0x0_24_0x0_32_0x54040000__ETC__q1 or
	  CASE_byte_addr112_16_0x28067_24_0x80000000_32__ETC__q2)
  begin
    case (byte_addr__h2112)
      64'd0: data64__h2414 = 64'h0202859300000297;
      64'd8: data64__h2414 = 64'h0182B283F1402573;
      default: data64__h2414 =
		   { CASE_byte_addr112_16_0x0_24_0x0_32_0x54040000__ETC__q1,
		     CASE_byte_addr112_16_0x28067_24_0x80000000_32__ETC__q2 };
    endcase
  end
