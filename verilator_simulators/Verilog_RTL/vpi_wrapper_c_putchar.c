 ...
 * $imported_c_putchar call=c_putchar_calltf size=32 acc=rw:%TASK
 * 
 * For a Verilog simulator which requires a .sft file, use the following entry:
 * $imported_c_putchar vpiSysFuncSized 32 unsigned
 */
#include <stdlib.h>
#include <vpi_user.h>
#include "bdpi.h"
...
/* sft: $imported_c_putchar vpiSysFuncSized 32 unsigned */

/* tab: $imported_c_putchar call=c_putchar_calltf size=32 acc=rw:%TASK */

PLI_INT32 c_putchar_sizetf(PLI_BYTE8 *user_data)
{
  return 32u;
}
...
void c_putchar_vpi_register()
{
  ...
  tf_data.sizetf = c_putchar_sizetf;
