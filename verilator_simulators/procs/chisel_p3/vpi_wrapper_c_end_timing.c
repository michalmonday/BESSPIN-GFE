 ...
 *     void (*vlog_startup_routines[])() = { c_end_timing_vpi_register, 0u };
 */
#include <stdlib.h>
#include <vpi_user.h>
#include "bdpi.h"
...
void c_end_timing(unsigned long long );
...
void c_end_timing_vpi_register()
{
  ...
  tf_data.tfname = "$imported_c_end_timing";
  tf_data.calltf = c_end_timing_calltf;
  tf_data.compiletf = 0u;
  tf_data.sizetf = 0u;
  tf_data.user_data = "$imported_c_end_timing";
