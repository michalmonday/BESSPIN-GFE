 ...
 *     void (*vlog_startup_routines[])() = { c_start_timing_vpi_register, 0u };
 */
#include <stdlib.h>
#include <vpi_user.h>
#include "bdpi.h"
...
void c_start_timing(unsigned long long );
...
void c_start_timing_vpi_register()
{
  ...
  tf_data.tfname = "$imported_c_start_timing";
  tf_data.calltf = c_start_timing_calltf;
  tf_data.compiletf = 0u;
  tf_data.sizetf = 0u;
  tf_data.user_data = "$imported_c_start_timing";
