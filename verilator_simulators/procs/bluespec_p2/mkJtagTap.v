...
module mkJtagTap(CLK,
  ...
  assign r_dmistat_busy$port2__read =
	     !WILL_FIRE_RL_dmi_reset && r_dmistat_busy$port1__read ;

  // register r_dmi
  assign r_dmi$D_IN = f_dmi_rsp$dD_OUT ;
  assign r_dmi$EN =
	     f_dmi_rsp$dEMPTY_N && f_dmi_busy$EMPTY_N && r_dmi[1:0] != 2'd2 &&
	     r_dmi[1:0] != 2'd3 ;
  ...
  // submodule f_dmi_busy
  assign f_dmi_busy$ENQ =
	     r_state_EQ_8_2_AND_r_ir_EQ_0x11_4_AND_NOT_r_dm_ETC___d72 &&
	     f_dmi_req$sFULL_N &&
	     f_dmi_busy$FULL_N &&
	     w_dmi_req$wget[1:0] != 2'd0 ;
  assign f_dmi_busy$DEQ = f_dmi_rsp$dEMPTY_N && f_dmi_busy$EMPTY_N ;
  assign f_dmi_busy$CLR = WILL_FIRE_RL_dmi_reset && r_dr[17] ;

  // submodule f_dmi_req
  assign f_dmi_req$sD_IN = w_dmi_req$wget ;
  assign f_dmi_req$sENQ =
	     r_state_EQ_8_2_AND_r_ir_EQ_0x11_4_AND_NOT_r_dm_ETC___d72 &&
	     f_dmi_req$sFULL_N &&
	     f_dmi_busy$FULL_N &&
	     w_dmi_req$wget[1:0] != 2'd0 ;
  assign f_dmi_req$dDEQ = f_dmi_req$dEMPTY_N && dmi_req_ready ;
  ...
  assign f_dmi_rsp$sENQ = f_dmi_rsp$sFULL_N && dmi_rsp_valid ;
  assign f_dmi_rsp$dDEQ = f_dmi_rsp$dEMPTY_N && f_dmi_busy$EMPTY_N ;
