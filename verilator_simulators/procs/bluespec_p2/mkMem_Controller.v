...
module mkMem_Controller(CLK,
  ...
  wire [172 : 0] f_reqs_rv$port1__read,
  ...
  wire CAN_FIRE_RL_rl_miss_clean_req,
  ...
  wire [172 : 0] MUX_f_reqs_rv$port1__write_1__VAL_1,
		 MUX_f_reqs_rv$port1__write_1__VAL_2;
  wire [72 : 0] MUX_slave_xactor_f_rd_data$enq_1__VAL_1,
		MUX_slave_xactor_f_rd_data$enq_1__VAL_2;
  wire [7 : 0] MUX_slave_xactor_f_wr_resp$enq_1__VAL_1,
  ...
  reg [63 : 0] rdata__h4983, word64_old__h5777;
  wire [63 : 0] exit_value__h7774,
		f_reqs_rv_BITS_164_TO_101_MINUS_rg_addr_base__q1,
		mask__h5781,
		req_raw_mem_addr__h3229,
		updated_word64__h5783,
		word64_new__h5782,
		x__h6156,
		y__h6157;
  ...
  wire NOT_cfg_verbosity_read_ULE_1___d5,
       ...
       rg_state_EQ_3_3_AND_NOT_f_reqs_rv_port0__read__ETC___d285,
  ...
  assign WILL_FIRE_RL_rl_writeback_dirty =
	     !f_raw_mem_reqs_rv$port1__read[353] && f_reqs_rv[172] &&
	     rg_state_EQ_3_3_AND_f_reqs_rv_port0__read__2_B_ETC___d130 &&
	     !rg_cached_raw_mem_addr_0_EQ_0_CONCAT_f_reqs_rv_ETC___d134 &&
	     !rg_cached_clean ;
  ...
  assign CAN_FIRE_RL_rl_miss_clean_req =
	     f_reqs_rv[172] && !f_raw_mem_reqs_rv$port1__read[353] &&
	     rg_state_EQ_3_3_AND_f_reqs_rv_port0__read__2_B_ETC___d130 &&
	     !rg_cached_raw_mem_addr_0_EQ_0_CONCAT_f_reqs_rv_ETC___d134 &&
	     rg_cached_clean ;
  ...
  assign WILL_FIRE_RL_rl_process_rd_req =
	     f_reqs_rv[172] && slave_xactor_f_rd_data$FULL_N &&
	     rg_state_EQ_3_3_AND_f_reqs_rv_port0__read__2_B_ETC___d130 &&
	     rg_cached_raw_mem_addr_0_EQ_0_CONCAT_f_reqs_rv_ETC___d134 &&
	     !f_reqs_rv[171] ;
  ...
  assign WILL_FIRE_RL_rl_process_wr_req =
	     f_reqs_rv[172] && slave_xactor_f_wr_resp$FULL_N &&
	     rg_state_EQ_3_3_AND_f_reqs_rv_port0__read__2_B_ETC___d130 &&
	     rg_cached_raw_mem_addr_0_EQ_0_CONCAT_f_reqs_rv_ETC___d134 &&
	     f_reqs_rv[171] ;
  ...
  assign WILL_FIRE_RL_rl_merge_rd_req =
	     slave_xactor_f_rd_addr$EMPTY_N && !f_reqs_rv$port1__read[172] ;

  // rule RL_rl_merge_wr_req
  assign WILL_FIRE_RL_rl_merge_wr_req =
	     !f_reqs_rv$port1__read[172] && slave_xactor_f_wr_addr$EMPTY_N &&
	     slave_xactor_f_wr_data$EMPTY_N &&
	     !WILL_FIRE_RL_rl_merge_rd_req ;

  // rule RL_rl_external_reset
  assign WILL_FIRE_RL_rl_external_reset =
  ...
  assign MUX_rg_state$write_1__SEL_1 =
	     WILL_FIRE_RL_rl_external_reset || rg_state == 2'd0 ;
  ...
  assign f_reqs_rv$port1__read =
	     f_reqs_rv$EN_port0__write ?
	       173'h0AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA :
	       f_reqs_rv ;
  ...
  assign f_reset_reqs$DEQ = WILL_FIRE_RL_rl_external_reset ;
  assign f_reset_reqs$CLR = 1'b0 ;

  // submodule f_reset_rsps
  assign f_reset_rsps$ENQ = WILL_FIRE_RL_rl_external_reset ;
  ...
  assign slave_xactor_f_rd_addr$DEQ = WILL_FIRE_RL_rl_merge_rd_req ;
  ...
  assign NOT_f_reqs_rv_port0__read__2_BITS_92_TO_90_6_E_ETC___d280 =
  ...
  assign exit_value__h7774 = { 1'd0, word64_new__h5782[63:1] } ;
  ...
  assign n__h4982 = { 3'd0, f_reqs_rv[105:104] } ;
  assign req_raw_mem_addr__h3229 =
	     { 5'd0,
  ...
  assign rg_cached_raw_mem_addr_0_EQ_0_CONCAT_f_reqs_rv_ETC___d134 =
	     rg_cached_raw_mem_addr == req_raw_mem_addr__h3229 ;
  assign rg_state_EQ_3_3_AND_NOT_f_reqs_rv_port0__read__ETC___d285 =
	     rg_state == 2'd3 &&
	     (NOT_f_reqs_rv_port0__read__2_BITS_92_TO_90_6_E_ETC___d280 ||
	      !rg_addr_base_23_ULE_f_reqs_rv_port0__read__2_B_ETC___d125 ||
	      !f_reqs_rv_port0__read__2_BITS_164_TO_101_24_UL_ETC___d127) ;
  ...
  assign rg_watch_tohost_36_AND_f_reqs_rv_port0__read___ETC___d242 =
	     ...
	     word64_new__h5782 != 64'd0 ;
  assign updated_word64__h5783 = x__h6156 | word64_new__h5782 ;
  assign word64_new__h5782 = f_reqs_rv[63:0] & mask__h5781 ;
  assign x__h6156 = word64_old__h5777 & y__h6157 ;
  assign y__h6157 =
	     { ~SEXT_f_reqs_rv_port0__read__2_BIT_71_89___d190,
	       ~SEXT_f_reqs_rv_port0__read__2_BIT_70_92___d193,
	       ~SEXT_f_reqs_rv_port0__read__2_BIT_69_96___d197,
  ...
  begin
    case (f_reqs_rv[105:104])
      2'd0: word64_old__h5777 = rg_cached_raw_mem_word[63:0];
      2'd1: word64_old__h5777 = rg_cached_raw_mem_word[127:64];
      2'd2: word64_old__h5777 = rg_cached_raw_mem_word[191:128];
      2'd3: word64_old__h5777 = rg_cached_raw_mem_word[255:192];
    endcase
  end
  always@(n__h4982 or rg_cached_raw_mem_word)
  begin
    case (n__h4982)
      5'd0: rdata__h4983 = rg_cached_raw_mem_word[63:0];
      5'd1: rdata__h4983 = rg_cached_raw_mem_word[127:64];
      5'd2: rdata__h4983 = rg_cached_raw_mem_word[191:128];
      5'd3: rdata__h4983 = rg_cached_raw_mem_word[255:192];
      default: rdata__h4983 = 64'hAAAAAAAAAAAAAAAA /* unspecified value */ ;
    endcase
  end
  ...
  begin
    ...
    f_raw_mem_rsps_rv =
	257'h0AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;
    f_reqs_rv = 173'h0AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;
  ...
  begin
    ...
    v__h7530 = v__h7536 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req && NOT_cfg_verbosity_read_ULE_1___d5)
	$display("%0d: Mem_Controller.rl_process_wr_req: ", v__h7530);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req && NOT_cfg_verbosity_read_ULE_1___d5)
	$write("        ");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  rg_watch_tohost_36_AND_f_reqs_rv_port0__read___ETC___d242 &&
	  word64_new__h5782[63:1] == 63'd0)
	$display("PASS");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  rg_watch_tohost_36_AND_f_reqs_rv_port0__read___ETC___d242 &&
	  word64_new__h5782[63:1] != 63'd0)
	$display("FAIL %0d", exit_value__h7774);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  rg_watch_tohost_36_AND_f_reqs_rv_port0__read___ETC___d242)
	$finish({ 30'd0, word64_new__h5782[2:1] });
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h8248 = v__h8254 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_invalid_rd_address)
	$write("%0d: ERROR: Mem_Controller:", v__h8248);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_invalid_rd_address &&
	  NOT_f_reqs_rv_port0__read__2_BITS_92_TO_90_6_E_ETC___d280)
    ...
    v__h9032 = v__h9038 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_invalid_wr_address)
	$write("%0d: ERROR: Mem_Controller:", v__h9032);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_invalid_wr_address &&
	  NOT_f_reqs_rv_port0__read__2_BITS_92_TO_90_6_E_ETC___d280)
    ...
    v__h2770 = v__h2776 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_merge_rd_req &&
	  NOT_cfg_verbosity_read_ULE_2_2___d33)
	$display("%0d: Mem_Controller.rl_merge_rd_req", v__h2770);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_merge_rd_req &&
	  NOT_cfg_verbosity_read_ULE_2_2___d33)
	$write("        ");
    ...
    v__h3104 = v__h3110 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_merge_wr_req &&
	  NOT_cfg_verbosity_read_ULE_2_2___d33)
	$display("%0d: Mem_Controller.rl_merge_wr_req", v__h3104);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_merge_wr_req &&
	  NOT_cfg_verbosity_read_ULE_2_2___d33)
	$write("        ");
	...
	$write("\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (rg_state == 2'd0 && NOT_cfg_verbosity_read_ULE_1___d5)
	begin
	  v__h1706 = $stime;
	  #0;
	end
