...
//
// On Tue Feb  4 02:03:03 GMT 2020
//
//
// Ports:
// Name                         I/O  size props
...
// m_pcc_reset_value              O    83 const
// m_ddc_reset_value              O    83 const
// m_mtcc_reset_value             O    83 const
// m_mepcc_reset_value            O    83 const
...
module mkSoC_Map(CLK,
  ...
  output [82 : 0] m_pcc_reset_value;

  // value method m_ddc_reset_value
  output [82 : 0] m_ddc_reset_value;

  // value method m_mtcc_reset_value
  output [82 : 0] m_mtcc_reset_value;

  // value method m_mepcc_reset_value
  output [82 : 0] m_mepcc_reset_value;
  ...
  // value method m_pcc_reset_value
  assign m_pcc_reset_value = 83'h40000000000FFF7DA4000 ;

  // value method m_ddc_reset_value
  assign m_ddc_reset_value = 83'h40000000000FFF7DA4000 ;

  // value method m_mtcc_reset_value
  assign m_mtcc_reset_value = 83'h40000100000FFF7DA4000 ;

  // value method m_mepcc_reset_value
  assign m_mepcc_reset_value = 83'h40000000000FFF7DA4000 ;
